...
@RestController
@RequestMapping("M10")
public class SecurityAuthController10 {
    ...
    public JwtClientInfo selfClient(){
        System.out.println("=client=====SecurityAuthController10:M10===================");
    ...
    public JwtUserInfo selfUser(){
        System.out.println("=user======SecurityAuthController10:M10===================");
        if (macroTokenDomainService!=null){
    ...
    public ListResponse<String> self(){
        ...
        System.out.println("=self======SecurityAuthController10:M10===================");
        if (macroTokenDomainService!=null){
