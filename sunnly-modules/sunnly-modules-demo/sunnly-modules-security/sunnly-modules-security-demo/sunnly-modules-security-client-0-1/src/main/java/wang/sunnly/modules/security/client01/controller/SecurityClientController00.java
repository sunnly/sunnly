...
public class SecurityClientController00 {
    ...
    public JwtClientInfo selfClient(){
        System.out.println("=client=====SecurityClientController00:M01===================");
    ...
    public JwtUserInfo selfUser(){
        System.out.println("=user======SecurityClientController00:M01===================");
        if (macroTokenDomainService!=null){
    ...
    public ListResponse<String> self(){
        ...
        System.out.println("=self======SecurityClientController00:M01===================");
        if (macroTokenDomainService!=null){
