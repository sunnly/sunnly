...
//
///**
// * XssRequestGlobalFilter
// * 自定义防XSS攻击网关全局过滤器
// *
// * @author Sunnly
// * @since 2020/10/26 0026 23:01
// */
//@Slf4j
//@Component
...
//            return getMethod(exchange, chain);
//        }
...
//            request = toServerHttpRequestDecorator(request, bodyFlux, headers);
//
//            //封装request，传给下一级
...
//    }
//
//    private ServerHttpRequestDecorator toServerHttpRequestDecorator(ServerHttpRequest request, Flux<DataBuffer> bodyFlux, HttpHeaders headers) {
...
//    }
//
//    private Mono<Void> getMethod(ServerWebExchange exchange, GatewayFilterChain chain) {
